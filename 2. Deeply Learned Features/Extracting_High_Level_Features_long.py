...
incep_model = load_model("E:/ICHproject/IncepV3-longformat.hdf5")

### AlexNet
#alex_model = load_model("E:/ICHproject/AlexNet-Long_sgdlongformat.hdf5")


#LM_model = load_model("Late Merging=short.hdf5")


X_train = np.load("train_longformat_with_origianl.npy")
#X_test = np.load("test_longformat.npy")
y_train_au = np.load("y_train_long_with_origianl.npy")
...
np.savetxt('DLR_IncepModel_train_with_cinlcal.csv',
...
# =============================================================================
##AlexNet Normal
Alex_DL_features_train = feature_extractor(X_train, AlexNet_FE)

Alex_DL_features_test = feature_extractor(X_test, AlexNet_FE)


np.savetxt('DLR_AlexNet_train.csv', Alex_DL_features_train, delimiter=',')
np.savetxt('DLR_AlexNet_test.csv', Alex_DL_features_test, delimiter=',')
