...
train_dir=r'C:\Users\zy\Desktop\ACDC\training'
test_dir=r'C:\Users\zy\Desktop\ACDC\training'
...
class Dataset():
    ...
    def __init__(self, path, counter_max=0, type='4D'):
        ...
        for file in os.walk(path):
            ...
            search_string = os.path.join(path,  file[2][2] + ".nii.gz")  #what is this for really?
...
def get_dataset_short(search_dir):
    ...
    for x in range(len(dataset.patient_ids)):
        print('dataset.patient_ids[x]',dataset.patient_ids[x])
        #print('datasetimg_filenames',dataset['img_filenames'])
        ...
        #mask = nib.load(dataset.search_string_mask[x])
