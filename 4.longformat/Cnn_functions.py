...
def create_base_model(output = 2):
    """
    ...
    model.add(Conv2D(filters = 32, kernel_size = (3, 3), strides = 2, activation='relu', input_shape=(512,512,3)))
...
def create_alex_model(output = 2):
    """
    ...
    alex_model.add(Conv2D(filters=96, input_shape=(512,512,3), kernel_size=(11,11), strides=(4,4), padding="valid", activation = 'relu'))
    # Max Pooling
